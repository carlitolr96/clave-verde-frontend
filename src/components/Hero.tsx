...
function Hero() {
  ...
  useEffect(() => {
    ...
    setCheckOutDate(formatDate(twoDaysLater));
  }, []);

  return (
    <div
      className="relative h-screen bg-no-repeat bg-cover bg-center bg-[url('/Hero.jpg')]"
      id="home-page"
    >
      ...
      <div className="relative z-10 flex flex-col items-start justify-center h-full px-6 md:px-16 lg:px-24 xl:px-32 text-white">
        ...
        <TitleSection title={t("hero.title")} subTitle={t("hero.subTitle")} />
